...
<body>
    ...
    <div class="login-container pt-5">
        <h1 style="font-size:48px" class="text-center pb-5">Tarjoilut</h1>
        <div>
            <div class="row">
                    <p class="sideText">
                        <br>
                        <img src="./images/tarjoilu.jpg" alt="hawaii" width="800" height="400">
                        <br>
                        <br>
                        Meiltä saat upeat tarjoilut häihin, vaihtoehdot joka budjetille (minimi 20 henkeä).
                        <br>
                        1. Catering, oma tila/Bodom kartano, buffet-ruoka, kahvi ja kakku, ei-alkoholia ruokajuomat. Hinta 35 Eur / henkilö.
                        <br>
                        2. Catering, sama kuin yllä ja sisältää kuohuviinin, valkoviinin, punaviinin ja oluen. Hinta +35 Eur / aikuinen.
                        <br>
                        3. Klippan, 3 ruokalajin menu sis alkoholilliset ruokajuomat. Hinta 100 Eur / henki ja lapset 35 Eur.
                        <br>
