        ...
        <div class="">
            ...
            <form action="register.php" method="post">
                <div class="container">
                    ...
                    <a href="login.php" class="newUser">On jo käyttäjä?</a>
                    <p style="font-size:12px"><b style="font-size:16px">Huom!</b> <br><br>Sähköpostiosoitteen pitää olla yksilöllinen ja salasanan pitää olla vähintään 4 merkkiä pitkä!</p>
                </div>
            </form>
        </div>
    </div>
