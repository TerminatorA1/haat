...
<body>
    ...
    <div class="login-container pt-5">
        <h1 style="font-size:48px" class="text-center pb-5">Hääpaikat</h1>
        <div>
            <div class="row">
                    <p class="sideText">
                        <br>
                        <img src="./images/paikka.jpg" width="800" height="400">
                        <br>
                        <br>
                        Meiltä saat varattua häätilan, vaihtoehdot ovat:
                        <br>
                        1. Oma tila, ilmainen
                        <br>
                        2. Espoo, Bodom-järven kartano, 1 päivä, 800,- (saa tarjota omat juomat)
                        <br>
                        3. Helsinki, ravintola Klippan, 6 tuntia, 2000,- (kaikki tarjoilut ravintolasta)
                        <br>
                        4. Muu tila, sopimuksen mukaan.
                        <br>
                        Jotta pystyt näkemään kaikki hinnat ja vaihtoehdot, sinun pitää ensin kirjautua sisään.
                        <br>
