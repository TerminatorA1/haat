    ...
    <div class="login-container ">
        <div class="container login-form-1">
            ...
            <form action="user.php" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button href="tilaus.php" type="submit" class="btn btn-primary btn-lg aloitaButton btn-block" name="update_info" style="border-radius:30px; font-size:30px;">Tallenna Tiedot</button>
                    </div>
                </div>
