...
<body>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <?php  if (isset($_SESSION['email'])) : ?>
                  ...
                  <li class="nav-item"><a class="nav-item nav-link" href="omatt.php">Tilaushistoria</a></li>
    ...
    <div class="login-container pt-5">
        <h1 style="font-size:48px" class="text-center pb-5">Yhteystiedot</h1>
        <div>
            <div class="row">
                    <p class="sideText">
                        <br>
                        <img src="./images/yhteystiedot.jpg" alt="hawaii" width="800" height="400">
                        <br>
                        <br>
                        Yhtiömme tiedot:
                        <br>
                        Hääsivusto Oy (y-tunnus: 1234567-9, alv rek)
                        <br>
                        Mannerheimintie 1, 00100 Helsinki
                        <br>
                        puh: 010 0000, e-mail: info (ät) haat.fi
                        <br>
                        Yrittäjä/tj: Helmi Humu (kuvassa yllä)
                        <br>
