...
<body>
    <nav class="navbar navbar-default navbar-expand-lg navbar-light scrolling-navbar fixed-top">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right ml-auto">
                <?php  if (isset($_SESSION['email'])) : ?>
                <li class="nav-item"><a class="nav-item nav-link" href="index.php" style="color:rgb(52, 235, 113)">Kirjaudu Ulos</a></li>
                <?php else : ?>
    ...
    <div class="login-container pt-5">
        <h1 style="font-size:48px" class="text-center pb-5">Hääsivusto</h1>
        <div>
            <div class="row">
                    <p class="sideText">
                        Tervetuloa Hääsivustolle!
                        <br>
                        <img src="./images/etusivu.jpg" alt="hawaii" width="800" height="400">
                        <br>
                        <br>
                        Meiltä saat varattua häätilan, esiintyjät, koristelut ja tarjoilut.
